...
import { Flex, Box, Popover, Typography, Button, LinkButton, Link, Portal, Alert, Field, SubNav, Badge, Combobox, ComboboxOption } from "@strapi/design-system";
import { WarningCircle, CaretDown, Globe } from "@strapi/icons";
...
const useQueryParams = (initialParams) => {
  ...
  const setQuery = useCallback((nextParams, method = "push", replace2 = false) => {
    let nextQuery = {
      ...query
    };
    if (method === "remove") {
      ...
      children: [
        /* @__PURE__ */ jsxs(
          Combobox,
          {
            ...
            style: { width: "100%" },
            children: [
              /* @__PURE__ */ jsxs(ComboboxOption, { value: "all", children: [
                "🌐 All locales (",
                locales.length,
                ")"
              ] }, "all"),
              locales.map((locale) => /* @__PURE__ */ jsx(ComboboxOption, { value: locale.code, children: locale.name }, locale.code))
            ]
          }
        ),
        translationProgress && /* @__PURE__ */ jsx("div", { style: { fontSize: "12px", color: "#666", width: "100%" }, children: translationProgress }),
        /* @__PURE__ */ jsxs(
          "div",
          {
            style: {
